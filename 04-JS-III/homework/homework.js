...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  if (array[array.indexOf(elemento)] == elemento) { return true;}
  else{return false;}
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  var mes =[] ;
  if (array[array.indexOf("Enero")] == "Enero" && array[array.indexOf("Noviembre")] == "Noviembre" && array[array.indexOf("Marzo")] == "Marzo" ) 
    { 
    for (var i = 0; i < array.length; i++) {
