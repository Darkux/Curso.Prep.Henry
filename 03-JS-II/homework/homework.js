...
function fizzBuzz(numero) {
  ...
  // De lo contrario, devuelve el numero
   if (numero/3 - Math.floor(numero/3) == 0 && numero/5 - Math.floor(numero/5) == 0) { return "fizzbuzz";} 
           if (numero/3 - Math.floor(numero/3) == 0 ) { return "fizz";} 
           if (numero/5 - Math.floor(numero/5) == 0 ) { return "buzz";} 
  return numero;
...
if (numero ==0 || numero == 1 || numero == 4 || numero == 9) {return false;}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  let  num = [0,6,12,18,24,30,36,42,48,54,60];
  return num;
}
